...
define('DB_CONFIG_DIR', '/hsphere/local/home/ronnie/dechasamediablog.com/140dev/db/'); 

// Server path for scripts within the framework to reference each other 
define('CODE_DIR', '/hsphere/local/home/ronnie/dechasamediablog.com/140dev/'); 

// External URL for Javascript code in browsers to call the framework with Ajax 
define('AJAX_URL', 'http://wwww.dechasamediablog.com/140dev/'); 
